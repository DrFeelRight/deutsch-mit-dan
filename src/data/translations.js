...
export const TRANSLATIONS_DE = [
  ...
  { id: 'trd3', level: 3, errorCat: 'vocab', source: 'Er arbeitet bei einer großen Firma.', accept: ['He works at a big company.', 'He works for a big company', 'He works at a large company'], explanation: '"bei" + dative is used for the employer: "bei einer großen Firma".' },
];
